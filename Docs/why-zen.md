...
- Agent profiles (`Developer`, `Builder`, `Minimal`, `Xcode`, `Planner`, `Reviewer`, `Reporter`) with dedicated tools, skills, model bindings, and instructions — see [agents.md](agents.md).
