...
extension SwiftFeatureRuntime {
    ...
    private static let canonicalManagementToolDescriptors: [DirectToolDescriptor] = [
        ...
        DirectToolDescriptor(
            ...
            description: "Promotes a generated Swift feature into a local ZenCODE Git checkout under Sources/Features, updates the declarative and Swift catalogs, and rolls back the package and catalogs if publication fails.",
            inputSchema: #"{"type":"object","properties":{"id":{"type":"string"},"featureID":{"type":"string"},"feature_id":{"type":"string"},"name":{"type":"string"},"sourcePath":{"type":"string"},"source_path":{"type":"string"},"checkoutPath":{"type":"string"},"checkout_path":{"type":"string"},"repositoryPath":{"type":"string"},"repository_path":{"type":"string"},"repository":{"type":"string"},"zenPackagePath":{"type":"string"},"zen_package_path":{"type":"string"},"dependencyPath":{"type":"string"},"dependency_path":{"type":"string"},"directory":{"type":"string"},"directoryPath":{"type":"string"},"directory_path":{"type":"string"},"targetPath":{"type":"string"},"target_path":{"type":"string"},"destination":{"type":"string"},"destinationPath":{"type":"string"},"destination_path":{"type":"string"},"overwrite":{"type":"boolean"},"replace":{"type":"boolean"},"build":{"type":"boolean"},"verifyBuild":{"type":"boolean"},"timeoutSeconds":{"type":"number"},"timeout":{"type":"number"},"isInstalledOnLinux":{"type":"boolean"},"is_installed_on_linux":{"type":"boolean"},"linux":{"type":"boolean"},"supportedOnLinux":{"type":"boolean"},"supported_on_linux":{"type":"boolean"},"platforms":{"type":"array","items":{"type":"string"}}},"required":["id"]}"#,
            presentation: .standard(title: "Feature", action: "Promote", kind: .create, targetKeyPaths: ["id", "featureID", "feature_id", "name", "checkoutPath", "checkout_path"])
        ),
        DirectToolDescriptor(
