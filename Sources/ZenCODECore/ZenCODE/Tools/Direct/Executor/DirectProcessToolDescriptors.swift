...
enum DirectProcessTools {
    ...
    static let descriptors: [DirectToolDescriptor] = [
        DirectToolDescriptor(
            ...
            inputSchema: #"{"type":"object","properties":{"command":{"type":"string"},"workingDirectory":{"type":"string"},"background":{"type":"boolean","description":"Start the command as a background job and return a job id immediately."},"timeoutSeconds":{"type":"number"},"timeout":{"type":"number"}},"required":["command"]}"#,
