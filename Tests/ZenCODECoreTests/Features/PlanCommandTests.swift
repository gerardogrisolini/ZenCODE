...
struct PlanCommandTests {
    ...
    func plannerRuntimePolicyRequiresBrainstormingForEveryNewDiscussion() throws {
        ...
        #expect(policy.contains("Every new Planner discussion starts with a mandatory brainstorming phase"))
        ...
        #expect(policy.contains("lasts for as many turns as necessary"))
        #expect(policy.contains("Do not produce the plan while material decisions remain unresolved"))
        #expect(policy.contains("everything needed for implementation is clear"))
