...
//  show the canonical tool name on the title line followed by the resolved
//  target on the status line; semantic target extraction is shared with the
//  expanded and ACP presentations.
//
